...
// Token bodies below are synthetic repeated characters, never provider credentials.
func TestSlackTokenPattern(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			valid: []string{
				"xoxb-" + "0000000000-0000000000-" + strings.Repeat("a0", 12),
				"xoxp-" + "0000000000-0000000000-" + strings.Repeat("a0", 7),
				"xoxa-" + strings.Repeat("a0", 5),
				"xoxr-" + strings.Repeat("a0", 5),
				"xoxs-" + "0000000000-0000000000-" + strings.Repeat("a0", 19)[:37],
			},
			invalid: []string{
		...
		},
		{
			...
			valid: []string{
				"xoxe-" + strings.Repeat("a0", 6),
				"xoxe.xoxb-" + "0000000000-0000000000-" + strings.Repeat("a0", 9)[:17],
				"xoxe.xoxp-" + "0000000000-0000000000-" + strings.Repeat("a0", 9),
			},
			invalid: []string{
		...
		},
		{
			...
			valid: []string{
				"xapp-" + strings.Repeat("a0", 6),
				"xapp-" + "0000000000-0000000000-" + strings.Repeat("a0", 13),
			},
			invalid: []string{
...
func TestStripeAPIKeyPattern(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			valid: []string{
				"sk_live_" + strings.Repeat("a0", 18),
				"sk_live_" + strings.Repeat("a0", 13),
				"sk_test_" + strings.Repeat("a0", 18),
				"sk_test_" + strings.Repeat("a0", 13),
			},
			invalid: []string{
		...
		},
		{
			...
			valid: []string{
				"rk_live_" + strings.Repeat("a0", 18),
				"rk_test_" + strings.Repeat("a0", 18),
			},
			invalid: []string{
