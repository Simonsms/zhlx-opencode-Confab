...
func spawnDaemonImpl(launch *daemonLaunchInput) error {
	...
	// Detach the daemon so it outlives the hook process. POSIX: new process
	// group (Setpgid). Windows: CREATE_NEW_PROCESS_GROUP | DETACHED_PROCESS.
	// See detachedProcAttr in procattr_*.go.
